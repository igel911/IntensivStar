package ru.mikhailskiy.intensiv.presentation.ui.search
...
import ru.mikhailskiy.intensiv.presentation.ui.feed.MovieItem
...
class SearchFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        disposable = getSearchByQuery
            .compose(SingleThreadTransformer<MoviesResponseDto>())
